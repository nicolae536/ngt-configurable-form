...
export class ConfigurationChangeFactoryService {
    ...
    //     flattenConfigRef.set(payload.element.name, newElConfig as IElementConfig | IGroupElementConfig);
    //
    ...
    //  */
    // updateElementValidation(ngFormControls: FormGroup, newElConfig: Dictionary<any>) {
    ...
    //  */
    // private getConfigurationUpdates(flattenConfigRef: Map<string, IElementConfig | IGroupElementConfig>,
    //                                 ngFormGroup: FormGroup): IElementChangePayload[] {
    ...
    //  * @returns {IElementChangePayload}
    //  */
    // private getNewConfigurationPayload(element: Dictionary<any>,
    //                                    newConfig: Dictionary<any>): IElementChangePayload {
    //     return {
    //         element: {
    //             ...element,
    //             ...newConfig
    ...
    //                            elementDesc: Dictionary<any>): boolean {
    //     // loop over configurationChangeMap to check if a configuration should be applyed
    //     for (const changeConfig of elementDesc.configurationChangeMap.configChangesMap) {
    ...
    //             const changedElementConfig = this.getNewConfigurationPayload(elementDesc, changeConfig.newConfig);
    ...
    //  * @returns {boolean}
    //  */
    // private areElementsEquals(element: Dictionary<any>, newElement: Dictionary<any>) {
    ...
    //         if (key === 'isDefaultConfig' ||
    //             key === 'configurationChangeMap' ||
    //             key === 'value') {
    //             continue;
    //         }
    //
    ...
    //  */
    // private getNewElementConfig(flattenConfigRef: Map<string, IElementConfig | IGroupElementConfig>,
    //                             payload: IElementChangePayload): Dictionary<any> {
    //     const elementConfig: IElementConfig | IGroupElementConfig = flattenConfigRef.get(payload.element.name) || {} as IElementConfig;
    ...
    //                             newElConfig: Dictionary<any>,
    //                             oldElement: Dictionary<any>) {
    ...
    // }
    //
    // private findElement(group: IGroupElementConfig,
    //                     elementId: string = null,
    ...
    //  * @param {IElementConfig} newElConfig
    //  */
    // private updateReferencesInFormConfig(params: IFoundElementParams, newElConfig: Dictionary<any>) {
    //     if (params && !params.element) {
    //         return;
    //     }
    //
    //     params.parentElementArray[params.index] = newElConfig as IGroupElementConfig | IElementConfig;
    //
